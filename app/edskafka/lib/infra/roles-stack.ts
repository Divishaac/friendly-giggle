...
export class RolesStack extends cdk.Stack {
    ...
    private getEcrGlobalPolicy(): void {
        ...
        const s3UploadBucket = new s3.Bucket( this, 'edskafka-bitbucket-s3-upload-artifacts-bucket', {
            versioned: true,
        ...
        new cdk.CfnOutput( this, "bitbucketRole", {
            ...
            exportName: 'edskafka-bitbucket-role'
        });
        ...
        new cdk.CfnOutput( this, "bitbucketS3Bucket", {
            ...
            exportName: 'edskafka-bitbucket-s3-upload-artifacts-bucket'
        });
    }
    ...
    private createBitBucketUser(): void {
        ...
        new cdk.CfnOutput( this, "userName", {
            ...
            exportName: 'edskafka-bitbucket-user'
        });
    }
    ...
    private createPipelineinfra(): void {
        ...
        const topic = new sns.Topic(this, 'edskafka-PipelineResultNotification', {
        ...
        const queue = new sqs.Queue(this, 'edskafka-pipelineresults');
        ...
        new cdk.CfnOutput( this, "sns-topic-output", {
            ...
            exportName: 'edskafka-PipelineResultNotification'
        });
    }
